" {{{ Setup
  ...
  let g:colors_name="10xDark"
" }}}
" {{{ Italics
  let g:ten_x_dark_italic = get(g:, 'ten_x_dark_italic', 0)
  let s:italic = ""
  if g:ten_x_dark_italic == 1
    let s:italic = "italic"
  endif
"}}}
" {{{ Bold
  let g:ten_x_dark_bold = get(g:, 'ten_x_dark_bold', 0)
  let s:bold = ""
  if g:ten_x_dark_bold == 1
   let s:bold = "bold"
  endif
"}}}
" {{{ Colors
